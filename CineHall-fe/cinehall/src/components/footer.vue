<template>
  <div class="relative mt-16 bg-gradient-to-r from-yellow-400 to-red-600">
    <svg
      class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16"
    ...
    <div
      class="px-4 pt-12 text-white mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8"
    >
